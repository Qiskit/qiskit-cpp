...
#ifndef __qiskitcpp_circuit_library_standard_gates_iswap_def_hpp__
#define __qiskitcpp_circuit_library_standard_gates_iswap_def_hpp__
...
/// @class ISwapGate
/// @brief definition of ISwap gate
class ISwapGate : public Instruction {
protected:
public:
    ISwapGate(void)
    {
...
#endif  //__qiskitcpp_circuit_library_standard_gates_iswap_def_hpp__

...
#ifndef __qiskitcpp_circuit_library_standard_gates_dcx_def_hpp__
#define __qiskitcpp_circuit_library_standard_gates_dcx_def_hpp__
...
/// @class DCXGate
/// @brief definition of DCX gate
class DCXGate : public Instruction {
protected:
public:
    DCXGate(void)
    {
...
#endif  //__qiskitcpp_circuit_library_standard_gates_dcx_def_hpp__

...
#ifndef __qiskitcpp_circuit_library_standard_gates_ecr_def_hpp__
#define __qiskitcpp_circuit_library_standard_gates_ecr_def_hpp__
...
/// @class ECRGate
/// @brief definition of ECR gate
class ECRGate : public Instruction {
protected:
public:
    ECRGate(void)
    {
...
#endif  //__qiskitcpp_circuit_library_standard_gates_ecr_def_hpp__

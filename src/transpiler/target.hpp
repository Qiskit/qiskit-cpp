...
Target::Target(const std::vector<std::string>& basis_gates, const std::vector<std::pair<uint32_t, uint32_t>>& coupling_map, double default_duration, double default_error)
{
...
void Target::add_instruction(const circuit::Instruction& instruction, const std::vector<InstructionProperty>& properties)
{
